...
export const PROJECTS: Project[] = [
  {
    ...
    tagKeys: ['minecraft', 'javascript', 'graaljs', 'java21', 'implement'],
    featured: true,
  ...
  },
  {
    ...
    tagKeys: ['rust', 'llms', 'fuzzy', 'patch', 'optimize'],
    featured: false,
  ...
  },
  {
    ...
    tagKeys: ['crypto', 'market', 'nestjs', 'tailwindcss', 'prisma', 'graphql', 'administer'],
    featured: true,
  ...
  },
  {
    ...
    tagKeys: ['manage', 'nextjs', 'react', 'typescript', 'tailwindcss', 'nextIntl', 'radixui', 'gsap'],
    featured: false,
  ...
  },
  {
    ...
    tagKeys: ['crypto', 'rust', 'tui', 'kraken', 'ohlcvt', 'dataCleaning', 'analysis', 'cli', 'lead'],
    featured: false,
  ...
  },
  {
    ...
    tagKeys: ['python', 'machineLearning', 'postgresql', 'recommendationSystem', 'optimization', 'dataScience', 'spotifyDataset', 'scikitLearn', 'collaborate'],
    featured: false,
